...
export const mockEvents: StreamEvent[] = [
  {
    ...
    description: "Watch our professional esports team compete in the latest Valorant tournament. Featuring high-level gameplay, strategic commentary, and exclusive behind-the-scenes content.",
